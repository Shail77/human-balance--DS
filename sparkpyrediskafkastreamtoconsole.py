...
# Note: before Spark 3.0.0, schema inference is not automatic

# create a StructType for the Kafka redis-server topic which has all changes
# made to Redis
...
# create a StructType for the Kafka stedi-events topic which has the
# Customer Risk JSON that comes from Redis
...
zSetDecodedEntriesStreamingDF = zSetEntriesEncodedStreamingDF.withColumn("customer",
                                                                         unbase64(
                                                                             zSetEntriesEncodedStreamingDF.encodedCustomer
                                                                         )
                                                                         .cast("string"))
