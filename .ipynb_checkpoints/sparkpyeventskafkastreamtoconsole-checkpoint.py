...
# execute a sql statement against a temporary view, selecting the customer and the score
# from the temporary view, creating a dataframe called customerRiskStreamingDF
